...
func (z *ShardInfo) Msgsize() (s int) {
	s = 1 + 3 + msgp.IntSize + 4 + msgp.IntSize + 7 + z.Status.Msgsize() + 5 + msgp.Int64Size + 9 + msgp.Uint64Size + 11 + msgp.StringPrefixSize + len(z.RangeStart) + 9 + msgp.StringPrefixSize + len(z.RangeEnd)
	return
}
